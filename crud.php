...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  if(isset($_POST['snoEdit'])){
    ...
    $sql="UPDATE `note details` SET `note_name` = '$title' , SET `note_desc` = '$description' WHERE `s.no` = $sno"; 
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="color:#ffffff;">
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="#" style="color:#ffffff; padding-left: 35px;">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="#" style="color:#ffffff; padding-left: 35px;">About</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="#" style="color:#ffffff; padding-left: 35px;">Contact Us</a>
          </li>
        </ul>
        <form class="d-flex">
